...
# --------------------- eSNLI and CoS-E to Circa explanation NLI Transfer ---------------
CIRCA_TRAIN_SIZE = 20560
...
MixtureRegistry.add(
    ...
    [("esnli_v010", ESNLI_SIZE),
     ...
     ("circa_v100_0_expln_nli_relaxed_matched13", CIRCA_TRAIN_SIZE),
     ("circa_eval_v100_nli_relaxed_matched13", CIRCA_VAL_SIZE)],
    default_rate=_rate_num_input_examples,
)
...
MixtureRegistry.add(
    ...
    [("esnli_v010", ESNLI_SIZE),
     ("esnli_v010_0_expln", ESNLI_SIZE),
     ("cos_e_v001_like_esnli", COS_E_SIZE),
     ("circa_v100_0_expln_nli_relaxed_matched948", CIRCA_TRAIN_SIZE),
     ("circa_eval_v100_nli_relaxed_matched948", CIRCA_VAL_SIZE)],
    default_rate=_rate_num_input_examples,
)
...
MixtureRegistry.add(
    ...
    [("esnli_v010", ESNLI_SIZE),
     ("esnli_v010_0_expln", ESNLI_SIZE),
     ("cos_e_v001_like_esnli", COS_E_SIZE),
     ("circa_v100_0_expln_nli_relaxed_matched2756", CIRCA_TRAIN_SIZE),
     ("circa_eval_v100_nli_relaxed_matched2756", CIRCA_VAL_SIZE)],
    default_rate=_rate_num_input_examples,
)
...
MixtureRegistry.add(
    ...
    [("esnli_v010_with_choices", ESNLI_SIZE),
     ...
     ("cos_e_v001", COS_E_SIZE),
     ("cos_e_v001_0_expln", COS_E_SIZE),
     ("circa_v100_0_expln_qa_relaxed_matched948", CIRCA_TRAIN_SIZE),
     ("circa_eval_v100_qa_relaxed_matched948", CIRCA_VAL_SIZE)],
    default_rate=_rate_num_input_examples,
)
...
MixtureRegistry.add(
    ...
    [("esnli_v010_with_choices", ESNLI_SIZE),
     ...
     ("cos_e_v001", COS_E_SIZE),
     ("cos_e_v001_0_expln", COS_E_SIZE),
     ("circa_v100_0_expln_qa_relaxed_matched2756", CIRCA_TRAIN_SIZE),
     ("circa_eval_v100_qa_relaxed_matched2756", CIRCA_VAL_SIZE)],
    default_rate=_rate_num_input_examples,
)
...
MixtureRegistry.add(
    ...
    [("esnli_v010_with_choices", ESNLI_SIZE),
     ...
     ("cos_e_v001", COS_E_SIZE),
     ("cos_e_v001_0_expln", COS_E_SIZE),
     ("circa_v100_0_expln_qa_strict_matched13", CIRCA_TRAIN_SIZE),
     ("circa_eval_v100_qa_strict_matched13", CIRCA_VAL_SIZE)],
    default_rate=_rate_num_input_examples,
)
...
MixtureRegistry.add(
    ...
    [("esnli_v010_with_choices", ESNLI_SIZE),
     ...
     ("cos_e_v001", COS_E_SIZE),
     ("cos_e_v001_0_expln", COS_E_SIZE),
     ("circa_v100_0_expln_qa_strict_matched948", CIRCA_TRAIN_SIZE),
     ("circa_eval_v100_qa_strict_matched948", CIRCA_VAL_SIZE)],
    default_rate=_rate_num_input_examples,
)
