...
# Circa - NLI, Relaxed, Unmatched
TaskRegistry.add(
    "circa_v100_0_expln_nli_relaxed_unmatched13",
    source=seqio.TfdsDataSource(tfds_name="circa_unmatched13:1.0.0", splits=["train", "validation", "test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    ...
    source=seqio.TfdsDataSource(
        tfds_name="circa_unmatched13:1.0.0", splits=["train"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_eval_v100_nli_relaxed_unmatched13",
    source=seqio.TfdsDataSource(
        tfds_name="circa_unmatched13:1.0.0", splits=["validation", "test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_v100_0_expln_nli_relaxed_unmatched948",
    source=seqio.TfdsDataSource(tfds_name="circa_unmatched948:1.0.0", splits=["train", "validation", "test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_v100_nli_relaxed_unmatched948",
    source=seqio.TfdsDataSource(
        tfds_name="circa_unmatched948:1.0.0", splits=["train"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_eval_v100_nli_relaxed_unmatched948",
    source=seqio.TfdsDataSource(
        tfds_name="circa_unmatched948:1.0.0", splits=["validation", "test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_v100_0_expln_nli_relaxed_unmatched2756",
    source=seqio.TfdsDataSource(tfds_name="circa_unmatched2756:1.0.0", splits=["train", "validation", "test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_v100_nli_relaxed_unmatched2756",
    source=seqio.TfdsDataSource(
        tfds_name="circa_unmatched2756:1.0.0", splits=["train"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_eval_v100_nli_relaxed_unmatched2756",
    source=seqio.TfdsDataSource(
        tfds_name="circa_unmatched2756:1.0.0", splits=["validation", "test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
# Circa - NLI, Strict, Matched Evaluation
TaskRegistry.add(
    "circa_v100_0_expln_nli_strict_matched13",
    source=seqio.TfdsDataSource(tfds_name="circa_matched13:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    ...
    source=seqio.TfdsDataSource(
        tfds_name="circa_matched13:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    ...
    source=seqio.TfdsDataSource(tfds_name="circa_matched948:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    ...
    source=seqio.TfdsDataSource(
        tfds_name="circa_matched948:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    ...
    source=seqio.TfdsDataSource(tfds_name="circa_matched2756:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    ...
    source=seqio.TfdsDataSource(
        tfds_name="circa_matched2756:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
# Circa - NLI, Strict, Unmatched
TaskRegistry.add(
    "circa_v100_0_expln_nli_strict_unmatched13",
    source=seqio.TfdsDataSource(tfds_name="circa_unmatched13:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_eval_v100_nli_strict_unmatched13",
    source=seqio.TfdsDataSource(
        tfds_name="circa_unmatched13:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_v100_0_expln_nli_strict_unmatched948",
    source=seqio.TfdsDataSource(tfds_name="circa_unmatched948:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_eval_v100_nli_strict_unmatched948",
    source=seqio.TfdsDataSource(
        tfds_name="circa_unmatched948:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_v100_0_expln_nli_strict_unmatched2756",
    source=seqio.TfdsDataSource(tfds_name="circa_unmatched2756:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
TaskRegistry.add(
    "circa_eval_v100_nli_strict_unmatched2756",
    source=seqio.TfdsDataSource(
        tfds_name="circa_unmatched2756:1.0.0", splits=["test"]),
    preprocessors=[
        functools.partial(
            preprocessors.circa,
            prefix=preprocessors.CircaPrefixes.nli,
...
# NLI - Hypothesis Only - Relaxed - Matched
TaskRegistry.add(
    "circa_nli_baseline_hypothesis_only_relaxed_matched13",
    source=seqio.TfdsDataSource(
        tfds_name="circa_matched13:1.0.0", splits=["train", "validation", "test"]),
    preprocessors=[
        functools.partial(
